# Generated by Django 5.1.1 on 2024-12-09 03:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('herramienta', 'Herramienta nueva'), ('bono', 'Bono de desempeño'), ('capacitacion', 'Curso de capacitación'), ('reconocimiento', 'Reconocimiento oficial')], max_length=50)),
                ('valor', models.DecimalField(blank=True, decimal_places=2, help_text='Valor monetario o equivalente', max_digits=10, null=True)),
                ...
                ('descripcion', models.TextField(blank=True, help_text='Detalles adicionales sobre la recompensa', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Reto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recompenzas_disponibles', models.ManyToManyField(blank=True, related_name='clientes', to='ServiceTrack.recompensa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puntos_otorgados', models.IntegerField()),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='retos_cliente', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='reto',
